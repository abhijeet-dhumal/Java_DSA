...
public class C_01_pract {
    ...
    public static void main(String[] args) {          //input type in the main function is String of arguments.
        ...
        /**
         ...
         // -----Concatenate (Adding 2 Extra.Strings)-----
        ...
        /*
             Extra.Strings in java are immutable, so by using substring function, we are not changing the original string.
         */

        // ARRAYS ------ 29:30     Non-Primitive Type
        /*
             In Java, P_01_ArrayList.Arrays are like a list of elements of the same type.
             FOR EXAMPLE: A list of integers for storing marks of diffrent subjects of a student.
             FOR EXAMPLE2: A list of booleans, etc....
         */

        // P_01_ArrayList.Arrays Type 1:
        ...
        /**
         ...
         System.out.println(marks.length);    // In P_01_ArrayList.Arrays, while using length function, we don't put ().
         **/
        ...
        /**
         System.out.println(marks[0]);
         P_01_ArrayList.Arrays.sort(marks);  // We imported P_01_ArrayList.Arrays package above to use sort function.
         System.out.println(marks[0]);  // this indicates that the array is sorted.
         **/

        //P_01_ArrayList.Arrays Type 2:
        ...
        */
        ...
        /**
         ...
         // Math Class in JAVA
         System.out.println("Using .max and .min Beginner.functions of Math Class");
